...
// src有多少个应用，使用util/multipleEntry.js下的paths代替原先的paths（删除旧的require）
...
const verifyPackageTree = require(paths.scriptVersion+'/scripts/utils/verifyPackageTree');
if (process.env.SKIP_PREFLIGHT_CHECK !== 'true') {
  verifyPackageTree();
}
const verifyTypeScriptSetup = require( paths.scriptVersion+ '/scripts/utils/verifyTypeScriptSetup');
...
function copyPublicFolder(buildPath) {
